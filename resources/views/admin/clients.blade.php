...
<!-- VENDOR CSS -->
<link rel="stylesheet" href="/assets3/vendor/bootstrap/css/bootstrap.min.css">
<link rel="stylesheet" href="/assets3/vendor/font-awesome/css/font-awesome.min.css">
<link rel="stylesheet" href="/assets3/vendor/sweetalert/sweetalert.css"/>
<link rel="stylesheet" href="/assets3/vendor/jquery-datatable/dataTables.bootstrap4.min.css">
<link rel="stylesheet" href="/assets3/vendor/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css">
...
<div class="page-loader-wrapper">
    <div class="loader">
        <div class="m-t-30"><img src="http://www.wrraptheme.com/templates/lucid/hr/html/assets3/images/logo-icon.svg" width="48" height="48" alt="Lucid"></div>
        <p>Please wait...</p>        
    </div>
</div>
    ...
    <nav class="navbar navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-brand">
                <a href="index.html"><img src="http://www.wrraptheme.com/templates/lucid/hr/html/assets3/images/logo.svg" alt="Lucid Logo" class="img-responsive logo"></a>                
            </div>
    ...
    <div id="left-sidebar" class="sidebar">
        <div class="sidebar-scroll">
            <div class="user-account">
                <img src="/assets3/images/user.png" class="rounded-circle user-photo" alt="User Profile Picture">
                <div class="dropdown">
                    <span>Welcome,</span>
                        ...
                        <ul class="main-menu metismenu">
                            ...
                            <li class="active">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="project-grid.html">Projects Grid</a></li>
        ...
        <div class="container-fluid">
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">                        
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Projects Grid</h2>
                        <ul class="breadcrumb">
            ...
            <div class="row clearfix">
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card">
                        <div class="body text-left pro-img">
                            <img class="mx-auto d-block mb-3" src="/assets3/images/projects/01.png" alt="">
                            ...
                            <div class="align-items-center d-flex">
                                ...
                                <ul class="list-unstyled team-info margin-0">
                                    <li><img src="/assets3/images/xs/avatar4.jpg" data-toggle="tooltip" data-placement="top" title="" alt="Avatar"
                                            data-original-title="Chris Fox"></li>
                                    <li><img src="/assets3/images/xs/avatar5.jpg" data-toggle="tooltip" data-placement="top" title="" alt="Avatar"
                                            data-original-title="Joge Lucky"></li>
                                    <li><img src="/assets3/images/xs/avatar2.jpg" data-toggle="tooltip" data-placement="top" title="" alt="Avatar"
                                            data-original-title="Folisise Chosielie"></li>
                                    <li><img src="/assets3/images/xs/avatar1.jpg" data-toggle="tooltip" data-placement="top" title="" alt="Avatar"
                                            data-original-title="Joge Lucky"></li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card">
                        <div class="body text-left pro-img">
                            <img class="mx-auto d-block mb-3" src="/assets3/images/projects/03.png" alt="">
                            ...
                            <div class="align-items-center d-flex">
                                ...
                                <ul class="list-unstyled team-info margin-0">
                                    <li><img src="/assets3/images/xs/avatar4.jpg" data-toggle="tooltip" data-placement="top" title="" alt="Avatar"
                                            data-original-title="Chris Fox"></li>
                                    <li><img src="/assets3/images/xs/avatar8.jpg" data-toggle="tooltip" data-placement="top" title="" alt="Avatar"
                                            data-original-title="Joge Lucky"></li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card">
                        <div class="body text-left pro-img">
                            <img class="mx-auto d-block mb-3" src="/assets3/images/projects/02.png" alt="">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card">
                        <div class="body text-left pro-img">
                            <img class="mx-auto d-block mb-3" src="01.png" alt="">
                            <h6 class="project-title text-primary mb-3"><a href="project-detail.html">iNext - Responsive Template</a></h6>
                    ...
                    <div class="card">
                        <div class="body text-left pro-img">
                            ...
                            <div class="align-items-center d-flex">
                                <h6 class="mb-0 mr-2">Team:</h6>
                                <ul class="list-unstyled team-info margin-0">
                                    <li><img src="/assets3/images/xs/avatar4.jpg" data-toggle="tooltip" data-placement="top" title=""
                                            alt="Avatar" data-original-title="Chris Fox"></li>
                                    <li><img src="/assets3/images/xs/avatar8.jpg" data-toggle="tooltip" data-placement="top" title=""
...
<script src="/assets3/bundles/vendorscripts.bundle.js"></script>

<script src="/assets3/bundles/datatablescripts.bundle.js"></script>
<script src="/assets3/vendor/sweetalert/sweetalert.min.js"></script> <!-- SweetAlert Plugin Js --> 

<script src="/assets3/bundles/mainscripts.bundle.js"></script>
<script src="/assets3/js/pages/tables/jquery-datatable.js"></script>
<script src="/assets3/js/pages/ui/dialogs.js"></script>
<script src="/assets3/vendor/bootstrap-progressbar/js/bootstrap-progressbar.min.js"></script>
<script>
    $(function () {
