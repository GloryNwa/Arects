                ...
                <div class="tab-pane animated fadeIn" id="sub_menu">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu">
                            ...
                            <ul class="main-menu metismenu">
                             <li><a href="/manage/clients"><i class="fa fa-arrows-alt"></i><span>Manage Clients</span></a></li>
                            <li><a href="/manage/ongoing/projects"><i class="icon-settings"></i><span>Manage Ongoing Projects</span></a></li>
                            
                            <li><a href="/manage/past/projects"><i class="icon-tag"></i>Manage Past Projects</a></li>
                        </ul>  
